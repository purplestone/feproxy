...
const replaceByLocal = {
  'ui/SplitWidget.js': {
    '// Force layout.': "this._parentWidget.element.matches('.vbox.root-view') ? parent.postMessage(JSON.stringify({event: '_onResizeEnd',data: this._mainElement.offsetWidth }), '*') : 0;",
  },
};
